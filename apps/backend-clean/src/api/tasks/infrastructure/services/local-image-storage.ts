...
import type { ImageFile, ImageStorage } from '../../application/ports/image-storage.port';
import { UnsupportedImageTypeError } from '../../domain/errors/task.errors';
...
/**
 * ImageStorage Port のローカルファイルシステム実装（infrastructure 層）。
